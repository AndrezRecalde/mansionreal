...
export default function GuestsRankingTable() {
    ...
    return (
        ...
        >
            <TitlePage order={3}>
                {PAGE_TITLE.DASHBOARD.TABLE_RANKING_HUESPEDES.TITLE}
            </TitlePage>
            <Table striped withTableBorder withColumnBorders mt={20}>
                <Table.Thead
                    style={{ backgroundColor: isDark ? "#2C2E33" : "#C8C8C8" }}
                >
                    <Table.Tr>
                        <Table.Th>
                            {
                                PAGE_TITLE.DASHBOARD.TABLE_RANKING_HUESPEDES
                                    .COLUMNS.NOMBRE_HUESPED
                            }
                        </Table.Th>
                        <Table.Th>
                            {
